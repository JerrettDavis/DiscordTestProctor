...
{
    /// <inheritdoc />
    public partial class AddCertificationModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassingScorePercent = table.Column<int>(type: "integer", nullable: false, defaultValue: 80),
                    Created = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    LastModified = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "text", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Certifications_PassingScorePercent", "\"PassingScorePercent\" >= 1 AND \"PassingScorePercent\" <= 100");
                    table.ForeignKey(
                        name: "FK_Certifications_Guilds_GuildId",
                        column: x => x.GuildId,
                        principalTable: "Guilds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Certifications_Ranks_RankId",
                        column: x => x.RankId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certifications_GuildId_Name",
                table: "Certifications",
                columns: new[] { "GuildId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Certifications_RankId",
                table: "Certifications",
                column: "RankId");
